...
export INCLUDE="${DRIVE}:\\${PF}\\Microsoft Visual Studio ${VSVER}\\VC\\INCLUDE;${DRIVE}:\\${PFBARE}\\Microsoft SDKs\\Windows\\${SDKVER}\\include;${DRIVE}\\${PFBARE}\\Windows Kits\\${SDKVER}\\include\um;${DRIVE}\\${PFBARE}\\Windows Kits\\${SDKVER}\\include\\shared"
export INCLUDE="${DRIVE}:\\${PFBARE}\\Windows Kits\\${SDKVER}\\include\\um;${DRIVE}:\\${PFBARE}\\Windows Kits\\${SDKVER}\\include\\shared;${DRIVE}:\\${PF}\\Microsoft Visual Studio ${VSVER}\\VC\\INCLUDE;${DRIVE}:\\${PFBARE}\\Microsoft SDKs\\Windows\\${SDKVER}\\include;"
if [ "$ARCH" = x86_64 ] ; then
    echo Configuring for 64 bit builds
    export LIB="${DRIVE}:\\${PF}\\Microsoft Visual Studio ${VSVER}\\VC\\LIB\\amd64;${DRIVE}:\\${PFBARE}\\Microsoft SDKs\\Windows\\${SDKVER}\\lib\x64;${DRIVE}:\\${PFBARE}\\Windows Kits\\${SDKVER}\\Lib\\win8\\um\\x64"
    export PATH="`pwd`/bin:/cygdrive/${DRIVE}/${PF}/Microsoft Visual Studio ${VSVER}/Common7/IDE:/cygdrive/${DRIVE}/${PF}/Microsoft Visual Studio ${VSVER}/VC/BIN/amd64:/cygdrive/${DRIVE}/${PF}/Microsoft Visual Studio ${VSVER}/Common7/Tools:/cygdrive/${DRIVE}/WINDOWS/Microsoft.NET/Framework/v3.5:/cygdrive/${DRIVE}/WINDOWS/Microsoft.NET/Framework/v2.0.50727:/cygdrive/${DRIVE}/${PF}/Microsoft Visual Studio ${VSVER}/VC/VCPackages:/cygdrive/${DRIVE}/${PFBARE}/Microsoft SDKs/Windows/${SDKVER}/bin:/cygdrive/${DRIVE}/${PFBARE}/Windows Kits/${SDKVER}/bin/x64:/cygdrive/${DRIVE}/WINDOWS/system32:/cygdrive/${DRIVE}/WINDOWS:/cygdrive/${DRIVE}/bin:/cygdrive/${DRIVE}/usr/bin:/cygdrive/${DRIVE}/usr/local/bin:/bin:/usr/bin:/usr/local/bin"
else 
